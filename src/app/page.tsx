...
// --- Custom SVG Components (Zero External Dependencies!) ---
...
const ChatBubble = ({
  ...
  <div
    className={`max-w-xs rounded-2xl p-4 shadow-lg ${isUser ? "ml-auto bg-blue-500 text-white" : "bg-white text-gray-800"} ${className || ""}`}
  >
    ...
    <section className="py-24 sm:py-32">
      <div className="container relative mx-auto max-w-7xl px-4">
        <div className="absolute inset-0 flex items-center justify-center">
          <span className="text-center font-poppins text-7xl font-extrabold text-gray-100 sm:text-8xl md:text-9xl">
            Trusted By
          </span>
        </div>
        <div className="relative z-10 grid grid-cols-2 items-center justify-items-center gap-y-10 sm:grid-cols-3 lg:grid-cols-5">
          {logos.map((name) => (
            <div
              key={name}
              className="hover-lift flex h-12 w-32 items-center justify-center rounded-md bg-gray-100 shadow-sm transition-colors duration-200 hover:bg-gray-200"
            >
              <span className="font-poppins font-semibold text-gray-500">
                {name}
              </span>
            </div>
          ))}
      ...
      <div className="container mx-auto grid max-w-7xl grid-cols-1 items-center gap-16 px-4 lg:grid-cols-2">
        ...
        >
          <motion.div
            ...
            className="absolute left-0 top-0 w-[85%] overflow-hidden rounded-lg border border-gray-200 shadow-xl"
          >
            <CodeSnippetMockup />
          </motion.div>
          ...
          <motion.div
            ...
            className="absolute bottom-0 right-0 w-[90%] overflow-hidden rounded-lg border border-gray-200 bg-white shadow-2xl"
          >
            <FeatureMockup />
          </motion.div>
          ...
          >
            <div className="floating-animation h-32 w-32 rounded-full bg-gradient-to-br from-blue-100 to-green-100 opacity-20"></div>
          </motion.div>
        </motion.div>
      </div>
    </section>
...
// --- Enhanced Testimonial Section with Founders ---
